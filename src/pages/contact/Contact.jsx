...
const Contact = () => {
   ...
   return (
      <>
         ...
         <main className="w-full mx-auto px-2  bg-red-100 lg:w-9/12 md:px-6 mt-4 lg:mt-6 flex flex-col md:flex-row justify-between gap-10">
            <section className="w-full md:w-[30rem]  rounded-md p-6 h-72">
               {/* Card */}
               <div className="mb-10">
               ...
               <div>
                  ...
                  <div className="flex items-center gap-2  my-2 md:text-xl">
                     <CiPhone />
                     <a href="tel:+91-123-12345">91-456-23467</a>
                  </div>
